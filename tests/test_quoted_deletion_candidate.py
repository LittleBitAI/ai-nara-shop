...
class V17MidSizeEntity(unittest.TestCase):
    ...
    def test_article_designation_of_sme_is_kept(self):
        ...
        for quote in ("「중소기업기본법」 제2조에 따른 업체",
                      ...
                      # 리뷰 라운드 6: 연결 표현이 달라도 제2조가 정한 자격이다
                      "「중소기업기본법」 제2조의 규정에 따른 업체 또는 소상공인",
                      "「중소기업기본법」 제2조에 의한 업체 또는 소상공인",
                      "중소기업기본법 제2조에서 정한 기업 또는 소상공인",
                      # 리뷰 라운드 7: 뒤에 오는 다른 법률 제목 안의 `소상공인` 은 자격 주체가 아니다
                      "「중소기업기본법」 제2조 및 「소상공인 보호 및 지원에 관한 법률」 제2조에 따른 업체 또는 소상공인",
                      "중소기업기본법 제2조 및 소상공인기본법 제2조에 따른 업체 또는 소상공인",
                      # 리뷰 라운드 8: 가리개가 구분자 앞의 자격 주체까지 삼키지 않는다
                      "중소기업기본법 제2조에 따른 기업,소상공인기본법 제2조상 소상공인",
                      # 조문 바로 뒤에서 자격 주체를 못 찾으면 무엇을 정했는지 모른다. 내리지 않는다
