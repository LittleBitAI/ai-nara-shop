...
| P2 | 9/18~9/21 | 명세 24개·매핑·라벨 파일럿·지시문 | 3항목 파일럿 승인 후 확대; dev 라벨 기준선·예산 통과 후 대량 실행 | **부분·정체.** `specs/`·`rules/law_map.json`은 없다. 라벨은 dev 33건(`reports/label-compare/opus5-cover3`)에서 멈췄고 무라벨 20,000건에는 한 건도 안 붙였다. 무라벨은 지금 **발화율 카나리**로만 쓰고 있다 |
