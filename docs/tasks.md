...
고정 회차 v20 TP 상한 2 재확인. 검사 19개, 전체 293 통과.
**독립 리뷰 라운드 1은 `머지 불가`** — 문서 불일치·OFF/ON 주장은 고쳤고, 운영 `script.py:668`의
v13 근거 구멍(A8 이 만든 것 아님, 현재도 3셀 발화)은 별건 판단 대기다. GPU·무라벨·서버 미실행.
PR #84(코드 `713aa83`, 노트북 `91dd9c3`). 열린 PR #82(`wiki-rag-pilot`)는 **다른 가설**이다 —
