...
# 2026-09-20: colab-1789861367622882347의 dev↔dev-debug가 같은 세션·같은 코드·같은 입력에서
# 36셀·0.004689를 냈다. 상한이 0.003129에서 올라갔다 — 이 값도 상한이라는 보장은 없다.
DRIFT_MIN = 0.000007917373
DRIFT_MAX = 0.004689228990
DRIFT_CELLS = (29, 45)
DRIFT_PAIRS = 11
