...
#  - 네 셀: D10 의 v6 올림(#128)이 모델이 놓친 시·군·구 제한 둘(`070`·`071`)을 세운다.
#    정답은 둘 다 v6=1 이다.
#  - v23·e23 셀만: D11 이 v23 을 조문의 기간(설명일 → 제안서 제출마감일, 낙찰자 결정기준
#    제7장 제3절 2-다)으로 판정하고 모델을 덮는다. 적용범위(지방+협상) 밖은 0 이다.
#    세 목록에서 `27`·`28`·`139`·`141` 이 서고 `109` 가 내려가며, `140` 은 값은 같고
#    인용만 바뀐다. `H2` 목록에는 그 회차에만 있는 `035` 가 더 내려간다.
#    v23·e23 밖으로 움직인 셀은 세 목록 모두 0 이다(reports/team-d/d11-v23-axis-a).
...
#    v21 (or its e-column): v11 absence from company_size facts (040·061·062), v19 timing from the
#    pledge line or its list heading (096·098·112), v3 quotes below a 1x-budget requirement
#    (112·170), v16/v18 judged on a complete notice (132·163·195·22), v21 needs a quoted share (143).
#
...
DELIBERATE_MOVES = [
    ("PPS-DEV-01", "v1"), ("PPS-DEV-03", "e3"), ("PPS-DEV-03", "v3"), ("PPS-DEV-036", "v19"),
    ("PPS-DEV-038", "e17"), ("PPS-DEV-038", "v17"), ("PPS-DEV-038", "v24"), ("PPS-DEV-039", "v21"),
    ("PPS-DEV-040", "v11"), ("PPS-DEV-046", "v24"), ("PPS-DEV-047", "v24"), ("PPS-DEV-050", "v9"),
    ("PPS-DEV-056", "v20"), ("PPS-DEV-060", "v24"), ("PPS-DEV-061", "v11"), ("PPS-DEV-061", "v24"),
    ...
    ("PPS-DEV-071", "v6"), ("PPS-DEV-073", "e24"), ("PPS-DEV-073", "v24"), ("PPS-DEV-088", "e9"),
    ("PPS-DEV-088", "v9"), ("PPS-DEV-090", "e9"), ("PPS-DEV-090", "v9"), ("PPS-DEV-091", "v24"),
    ("PPS-DEV-092", "v6"), ("PPS-DEV-096", "e19"), ("PPS-DEV-096", "v19"), ("PPS-DEV-098", "e19"),
    ("PPS-DEV-098", "v19"), ("PPS-DEV-099", "v24"), ("PPS-DEV-101", "v1"), ("PPS-DEV-102", "e17"),
    ("PPS-DEV-102", "e6"), ("PPS-DEV-102", "v17"), ("PPS-DEV-102", "v6"), ("PPS-DEV-103", "v24"),
    ("PPS-DEV-11", "e5"), ("PPS-DEV-11", "v5"), ("PPS-DEV-110", "e9"), ("PPS-DEV-110", "v9"),
    ("PPS-DEV-112", "e19"), ("PPS-DEV-112", "e3"), ("PPS-DEV-112", "v19"), ("PPS-DEV-112", "v3"),
    ("PPS-DEV-120", "e17"), ("PPS-DEV-120", "v17"), ("PPS-DEV-122", "e24"), ("PPS-DEV-122", "v24"),
    ("PPS-DEV-123", "v24"), ("PPS-DEV-124", "v20"), ("PPS-DEV-127", "v21"), ("PPS-DEV-127", "v3"),
    ("PPS-DEV-130", "v9"), ("PPS-DEV-131", "v20"), ("PPS-DEV-132", "v16"), ("PPS-DEV-132", "v20"),
    ("PPS-DEV-132", "v9"), ("PPS-DEV-134", "v20"), ("PPS-DEV-135", "v20"), ("PPS-DEV-144", "v20"),
    ("PPS-DEV-144", "v6"), ("PPS-DEV-145", "v24"), ("PPS-DEV-148", "e13"), ("PPS-DEV-15", "e24"),
    ("PPS-DEV-15", "v24"), ("PPS-DEV-153", "v24"), ("PPS-DEV-156", "e24"), ("PPS-DEV-156", "v24"),
    ("PPS-DEV-16", "v13"), ("PPS-DEV-160", "e9"), ("PPS-DEV-160", "v9"), ("PPS-DEV-162", "v9"),
    ("PPS-DEV-163", "v18"), ("PPS-DEV-170", "e3"), ("PPS-DEV-170", "v21"), ("PPS-DEV-170", "v3"),
    ("PPS-DEV-172", "e17"), ("PPS-DEV-172", "v17"), ("PPS-DEV-176", "v24"), ("PPS-DEV-182", "v24"),
    ("PPS-DEV-187", "v6"), ("PPS-DEV-188", "v21"), ("PPS-DEV-191", "e24"), ("PPS-DEV-191", "v24"),
    ("PPS-DEV-192", "e24"), ("PPS-DEV-192", "v24"), ("PPS-DEV-195", "v18"), ("PPS-DEV-195", "v24"),
    ("PPS-DEV-198", "v13"), ("PPS-DEV-199", "v24"), ("PPS-DEV-22", "v18"), ("PPS-DEV-24", "v20"),
    ("PPS-DEV-25", "e3"), ("PPS-DEV-25", "v3"), ("PPS-DEV-28", "v24"), ("PPS-DEV-29", "e24"),
    ("PPS-DEV-29", "v24"),
]
...
DELIBERATE_MOVES_H2 = [
    ("PPS-DEV-01", "v1"), ("PPS-DEV-036", "v19"), ("PPS-DEV-036", "v5"), ("PPS-DEV-038", "e17"),
    ("PPS-DEV-038", "v17"), ("PPS-DEV-042", "v21"), ("PPS-DEV-046", "v24"), ("PPS-DEV-047", "v24"),
    ("PPS-DEV-050", "v9"), ("PPS-DEV-060", "v24"), ("PPS-DEV-061", "v24"), ("PPS-DEV-062", "v24"),
    ("PPS-DEV-063", "v12"), ("PPS-DEV-066", "e24"), ("PPS-DEV-066", "v24"), ("PPS-DEV-070", "e6"),
    ("PPS-DEV-070", "v6"), ("PPS-DEV-071", "e6"), ("PPS-DEV-071", "v6"), ("PPS-DEV-073", "e24"),
    ("PPS-DEV-073", "v24"), ("PPS-DEV-088", "e9"), ("PPS-DEV-088", "v9"), ("PPS-DEV-09", "e6"),
    ("PPS-DEV-09", "v6"), ("PPS-DEV-091", "v24"), ("PPS-DEV-092", "v6"), ("PPS-DEV-096", "e19"),
    ("PPS-DEV-096", "v19"), ("PPS-DEV-098", "e17"), ("PPS-DEV-098", "e19"), ("PPS-DEV-098", "v17"),
    ("PPS-DEV-098", "v19"), ("PPS-DEV-099", "v24"), ("PPS-DEV-101", "v1"), ("PPS-DEV-102", "e6"),
    ("PPS-DEV-102", "v6"), ("PPS-DEV-11", "e5"), ("PPS-DEV-11", "v5"), ("PPS-DEV-110", "e9"),
    ("PPS-DEV-110", "v9"), ("PPS-DEV-112", "e19"), ("PPS-DEV-112", "e3"), ("PPS-DEV-112", "v19"),
    ("PPS-DEV-112", "v3"), ("PPS-DEV-122", "e24"), ("PPS-DEV-122", "v24"), ("PPS-DEV-123", "v24"),
    ("PPS-DEV-124", "v20"), ("PPS-DEV-127", "v21"), ("PPS-DEV-127", "v3"), ("PPS-DEV-130", "v9"),
    ("PPS-DEV-131", "v20"), ("PPS-DEV-132", "v16"), ("PPS-DEV-132", "v20"), ("PPS-DEV-133", "v20"),
    ("PPS-DEV-134", "v20"), ("PPS-DEV-135", "v20"), ("PPS-DEV-143", "e21"), ("PPS-DEV-143", "v21"),
    ("PPS-DEV-144", "v6"), ("PPS-DEV-148", "e13"), ("PPS-DEV-15", "e24"), ("PPS-DEV-15", "v24"),
    ("PPS-DEV-153", "e17"), ("PPS-DEV-153", "v17"), ("PPS-DEV-153", "v24"), ("PPS-DEV-156", "e24"),
    ("PPS-DEV-156", "v24"), ("PPS-DEV-16", "v13"), ("PPS-DEV-160", "e9"), ("PPS-DEV-160", "v9"),
    ("PPS-DEV-162", "v9"), ("PPS-DEV-169", "v24"), ("PPS-DEV-170", "e3"), ("PPS-DEV-170", "v3"),
    ("PPS-DEV-172", "e17"), ("PPS-DEV-172", "v17"), ("PPS-DEV-176", "v24"), ("PPS-DEV-187", "v6"),
    ("PPS-DEV-188", "v21"), ("PPS-DEV-191", "e24"), ("PPS-DEV-191", "v24"), ("PPS-DEV-192", "v24"),
    ("PPS-DEV-195", "v24"), ("PPS-DEV-198", "v13"), ("PPS-DEV-22", "v18"), ("PPS-DEV-24", "v20"),
    ("PPS-DEV-25", "e3"), ("PPS-DEV-25", "v3"), ("PPS-DEV-28", "v24"), ("PPS-DEV-29", "e24"),
    ("PPS-DEV-29", "v24"),
]
...
DELIBERATE_MOVES_A7 = [
    ...
    ("PPS-DEV-050", "v9"), ("PPS-DEV-056", "v20"), ("PPS-DEV-061", "v11"), ("PPS-DEV-062", "v11"),
    ("PPS-DEV-063", "v12"), ("PPS-DEV-064", "v20"), ("PPS-DEV-068", "v20"), ("PPS-DEV-070", "e6"),
    ("PPS-DEV-070", "v6"), ("PPS-DEV-071", "e6"), ("PPS-DEV-071", "v6"), ("PPS-DEV-088", "e9"),
    ("PPS-DEV-088", "v9"), ("PPS-DEV-090", "e9"), ("PPS-DEV-090", "v9"), ("PPS-DEV-092", "v6"),
    ("PPS-DEV-096", "e19"), ("PPS-DEV-096", "v19"), ("PPS-DEV-098", "e19"), ("PPS-DEV-098", "v19"),
    ("PPS-DEV-101", "v1"), ("PPS-DEV-102", "e17"), ("PPS-DEV-102", "e6"), ("PPS-DEV-102", "v17"),
    ("PPS-DEV-102", "v6"), ("PPS-DEV-11", "e5"), ("PPS-DEV-11", "v5"), ("PPS-DEV-110", "e9"),
    ("PPS-DEV-110", "v9"), ("PPS-DEV-112", "e19"), ("PPS-DEV-112", "e3"), ("PPS-DEV-112", "v19"),
    ("PPS-DEV-112", "v3"), ("PPS-DEV-120", "e17"), ("PPS-DEV-120", "v17"), ("PPS-DEV-124", "v20"),
    ("PPS-DEV-127", "v21"), ("PPS-DEV-127", "v3"), ("PPS-DEV-130", "v9"), ("PPS-DEV-131", "v20"),
    ("PPS-DEV-132", "v16"), ("PPS-DEV-132", "v20"), ("PPS-DEV-132", "v9"), ("PPS-DEV-134", "v20"),
    ("PPS-DEV-135", "v20"), ("PPS-DEV-144", "v20"), ("PPS-DEV-144", "v6"), ("PPS-DEV-148", "e13"),
    ("PPS-DEV-16", "v13"), ("PPS-DEV-160", "e9"), ("PPS-DEV-160", "v9"), ("PPS-DEV-162", "v9"),
    ("PPS-DEV-163", "v18"), ("PPS-DEV-170", "e3"), ("PPS-DEV-170", "v21"), ("PPS-DEV-170", "v3"),
    ("PPS-DEV-172", "e17"), ("PPS-DEV-172", "v17"), ("PPS-DEV-187", "v6"), ("PPS-DEV-188", "v21"),
    ("PPS-DEV-195", "v18"), ("PPS-DEV-198", "v13"), ("PPS-DEV-22", "v18"), ("PPS-DEV-24", "v20"),
    ("PPS-DEV-25", "e3"), ("PPS-DEV-25", "v3"), ("PPS-DEV-29", "e24"), ("PPS-DEV-29", "v24"),
]
