...
#  - 열두 셀: D7 의 적용범위 게이트가 v3·v5·v6 의 오탐 여섯 자리에서 값과 근거를 함께
#    비웠다. 배수를 인용 안에서 읽고(v3), 계약법별 고시금액 표를 상한·금액이 **둘 다
#    확인될 때만** 반증으로 쓰고(v5), 시·군·구 제한이 아닌 인용을 내린다(v6).
...
#  - 열두 셀: D7 의 적용범위 게이트(v3·v5·v6) 여섯 자리가 값과 근거를 함께 비웠다.
...
# D7 의 게이트 열두 셀도 여기에 더해진다 — 그 보관본은 A7 만 적용된 산출물이다.
DELIBERATE_MOVES_A7 = [
    ("PPS-DEV-01", "v1"), ("PPS-DEV-03", "e3"), ("PPS-DEV-03", "v3"),
