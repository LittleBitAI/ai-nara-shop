# a8-v20 회차 1 — 주입이 v20 을 한 칸도 못 움직였다

2026-09-22 등록. 두 회차 중 1 번째이며 짝은 [회차 2](../a8-v20-1790059133832323156/README.md)다.
...
| --- | --- | ---: | --- | ---: | ---: |
| control | off | 0.591008188119 | 1/4/4 | 259.825 | 6494.205 |
| control | on | 0.591008188119 | 1/4/4 | 259.825 | 6494.205 |
| a8 | off | 0.588468081167 | 1/4/4 | 252.497 | 6429.030 |
| a8 | on | 0.588468081167 | 1/4/4 | 252.497 | 6429.030 |

군 간 차이는 Macro F1 0.591008188119 → 0.588468081167 (-0.002540106952) 이고 바뀐 셀 8/4,800 인데 전부 대상 밖이다.
대상 밖 변화: v10 PPS-DEV-041·PPS-DEV-09·PPS-DEV-146·PPS-DEV-23, v12 PPS-DEV-106, v15 PPS-DEV-18, v17 PPS-DEV-035, v18 PPS-DEV-154.
...
| ID | 바뀐 필드 | gain_kind |
| --- | --- | --- |
| `PPS-DEV-28` | requirements_complete no→yes | `other` |
...
- ZIP `a8-v20-results-1790057577391794027.zip`, SHA-256 `c967b6a7db9aa74dc9989589e4da9d44cc0bec224bc616fec628b4dd9803b05a`
...
- 화면 항목은 `a8-v20-1790057577391794027.control-off`·`.control-on`·`.a8-off`·`.a8-on` 네 개다.
