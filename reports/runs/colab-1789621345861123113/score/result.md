...
- Macro F1: 0.22078771129
- 정답/예측: 200/200건, ID 집합 일치, 오답 287개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.014471초
...
```powershell
& '/content/t1-colab-7jprh479/venv/bin/python' '-X' 'utf8' '/content/t1-colab-7jprh479/tools/score.py' '--truth' '/content/t1-colab-7jprh479/open/dev_labels.csv' '--pred' '/content/t1-colab-7jprh479/results/dev/submission.csv' '--output-dir' '/content/t1-colab-7jprh479/results/score'
```
