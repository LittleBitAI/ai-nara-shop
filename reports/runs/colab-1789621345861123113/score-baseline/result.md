...
- Macro F1: 0.21753058248
- 정답/예측: 200/200건, ID 집합 일치, 오답 380개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.013631초
...
```powershell
& '/content/t1-colab-7jprh479/venv/bin/python' '-X' 'utf8' '/content/t1-colab-7jprh479/tools/score.py' '--truth' '/content/t1-colab-7jprh479/open/dev_labels.csv' '--pred' '/content/t1-colab-7jprh479/results/dev/baseline_submission.csv' '--output-dir' '/content/t1-colab-7jprh479/results/score-baseline'
```
