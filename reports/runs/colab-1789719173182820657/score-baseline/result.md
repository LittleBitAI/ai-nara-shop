...
- Macro F1: 0.330815195903
- 정답/예측: 200/200건, ID 집합 일치, 오답 327개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.014142초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'results/dev/baseline_submission.csv' '--output-dir' 'results/score-baseline'
```
