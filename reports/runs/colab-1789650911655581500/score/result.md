...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'results/dev/submission.csv' '--output-dir' 'results/score'
```
