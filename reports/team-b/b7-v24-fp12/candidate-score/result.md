...
- Macro F1: 0.625371672817
- 정답/예측: 200/200건, ID 집합 일치, 오답 113개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.379576초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-b/b7-v24-fp12/candidate-replay/submission.csv' '--output-dir' 'reports/team-b/b7-v24-fp12/candidate-score'
```
