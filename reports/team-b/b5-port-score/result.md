...
- Macro F1: 0.360883975416
- 정답/예측: 200/200건, ID 집합 일치, 오답 223개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.078000초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-b/b5-port-replay/submission.csv' '--output-dir' 'reports/team-b/b5-port-score'
```
