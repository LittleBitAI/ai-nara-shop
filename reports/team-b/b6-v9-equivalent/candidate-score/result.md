...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-b/b6-v9-equivalent/candidate-replay/submission.csv' '--output-dir' 'reports/team-b/b6-v9-equivalent/candidate-score'
```
