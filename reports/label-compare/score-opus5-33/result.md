...
- Macro F1: 0.620535714286
- 정답/예측: 33/33건, ID 집합 일치, 오답 47개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.072802초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'reports/label-compare/truth-cover3.csv' '--pred' 'reports/label-compare/opus5-cover3.csv' '--output-dir' 'reports/label-compare/score-opus5-33'
```
