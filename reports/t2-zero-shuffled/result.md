...
- Macro F1: 0
- 정답/예측: 200/200건, ID 집합 일치, 오답 153개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.079794초
...
```powershell
& 'C:\Users\dasdk\anaconda3\python.exe' '-X' 'utf8' 'tools/score.py' '--truth' 'open\dev_labels.csv' '--pred' 'C:\Users\Public\Documents\ESTsoft\CreatorTemp\t2-zero-9wp80_w2\zero.csv' '--output-dir' 'reports/t2-zero-shuffled'
```
