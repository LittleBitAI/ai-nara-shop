...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/d7-fp-gates/replay/submission.csv' '--output-dir' 'reports/team-d/d7-fp-gates/score'
```
