...
- Macro F1: 0.628528238474
- 정답/예측: 200/200건, ID 집합 일치, 오답 121개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.447076초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/d9-v6/replay/v6only-U+L1/submission.csv' '--output-dir' 'reports/team-d/d9-v6/replay/v6only-U+L1-score'
```
