...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/d9-v6/replay/v6only-L2C/submission.csv' '--output-dir' 'reports/team-d/d9-v6/replay/v6only-L2C-score'
```
