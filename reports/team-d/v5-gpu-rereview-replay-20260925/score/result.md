...
- Macro F1: 0.774243376449
- 정답/예측: 200/200건, ID 집합 일치, 오답 66개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.139327초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/v5-gpu-rereview-replay-20260925/submission.csv' '--output-dir' 'reports/team-d/v5-gpu-rereview-replay-20260925/score'
```
