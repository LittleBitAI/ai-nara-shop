...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/final/replay/submission.csv' '--output-dir' 'reports/team-d/final/score'
```
