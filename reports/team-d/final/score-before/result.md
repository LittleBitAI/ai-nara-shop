...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/final/head-c5055e4-replay/submission.csv' '--output-dir' 'reports/team-d/final/score-before'
```
