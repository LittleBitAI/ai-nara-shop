...
- Macro F1: 0.25987019063
- 정답/예측: 200/200건, ID 집합 일치, 오답 286개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.279758초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-d/d1-v8/replay/submission.csv' '--output-dir' 'reports/team-d/d1-v8/score-after'
```
