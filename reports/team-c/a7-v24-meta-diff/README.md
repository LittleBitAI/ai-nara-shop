...
| --- | ---: | ---: |
| dev 200건 | 31 | 15.5% |
| 무라벨 6,000건 | 1,156 | 19.3% |

**배율 1.243.** 채택된 v6 1.11 · v9 1.16 보다 약간 높고, 기각 사유가 됐던 v23 의 0.05 와는 멀다.
축별 무라벨 발화는 지역제한 733 · 업종 242 · 예산 236 이다.
...
> 라운드 6 리뷰가 잡았다. 고친 뒤 예산 축 발화는 19 → 5 다.
