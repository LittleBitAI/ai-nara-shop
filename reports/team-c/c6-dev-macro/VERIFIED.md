...
`main`(`0496ef0`)의 코드에 **이 후보 모듈을 한 번 더 얹어** 보면 **0셀**이 바뀐다 —
포팅이 빠뜨린 조건이 없다는 뜻이다.
...
| **(d)** | **대상 밖 항목의 회귀**가 0 인가 | §3 | **C 항목 밖 0셀** | D1 **통과 (금지선)** |
...
통과선 "v16 FP 감소 ≥2" 와 "v18 FN 감소 ≥2" 는 **고정 원응답**에서 나온 변화량이다.
