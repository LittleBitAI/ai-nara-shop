...
- Macro F1: 0.547985038075
- 정답/예측: 200/200건, ID 집합 일치, 오답 157개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.077805초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-c/a3-zero-items/baseline/submission.csv' '--output-dir' 'reports/team-c/a3-zero-items/baseline-score'
```
