...
- Macro F1: 0.61172432188
- 정답/예측: 200/200건, ID 집합 일치, 오답 152개
- 상태: draft. 독립 리뷰·사람 승인 없음.
- 로컬 채점·저장 준비: 0.078392초
...
```powershell
& 'python' '-X' 'utf8' 'tools/score.py' '--truth' 'open/dev_labels.csv' '--pred' 'reports/team-c/a4-scope-gate/candidate-replay/submission.csv' '--output-dir' 'reports/team-c/a4-scope-gate/candidate-score'
```
