"""C6 후보 D1 (좁음) — 직생 요구가 **하나도 없으면** `competitive` 를 v18 에 한해 안 믿는다.
...
뒤집으면 그 셋이 함께 죽는다. 그래서 이 후보는 **운영 판정 위에 v18 키 하나만** 덮는다.
...
재생:
    python -X utf8 tools/replay_run.py \
      ...
      --candidate experiments/c6_band_no_demand_narrow_candidate.py --output-dir <새 경로>
"""
