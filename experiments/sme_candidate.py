...
**이 상수는 국가계약법 제4조①의 고시금액만 모델링한다.** 같은 고시 2.가는
「공기업·준정부기관 계약사무규칙」 제4조①에 대해 7억 1천만 원을 따로 정한다.
dev 는 전 행이 국가·지방계약법이라 반례가 없지만, 히든셋에 그 규칙을 적용받는
공고가 있고 추정가격이 [2.3억, 7.1억) 이면 진짜 위반이 조용히 0 이 된다.
