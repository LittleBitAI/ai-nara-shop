...
0 으로 되돌릴 때는 근거문구도 함께 비운다 — `validate_csv` 가 판정 0 인 셀에
근거문구가 남아 있으면 거부한다.

금액 구간의 근거는 제공 법령 스냅샷이며 `reports/team-c/c3-amount-gate/README.md`
가 조문 위치를 적는다. 분포에 맞춘 값이 아니다.

**국가계약법 제4조①의 고시금액만 쓰는 것이 맞다.** 같은 고시 2.가가
「공기업·준정부기관 계약사무규칙」 제4조①에 대해 7억 1천만 원을 따로 정하지만,
이 항목군의 중심 조문인 판로지원법 시행령 제2조의2①2호가 상한으로
「국가를 당사자로 하는 계약에 관한 법률」 제4조제1항을 **법 이름과 조항까지 지목**한다.
지방 시행령 제20조①12호도 같다. 그래서 발주기관이 공기업·준정부기관이어도 2.3억이다.
